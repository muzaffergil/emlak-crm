...
export default function MapPage() {
  ...
  return (
    ...
    <div className="-mx-4 -my-6 relative" style={{ height: "calc(100vh - 56px)" }}>
      ...
      <div className="absolute bottom-4 left-4 z-[999] bg-white/90 backdrop-blur-sm rounded-xl shadow-lg p-3 flex flex-col gap-1.5">
        {LEGEND.map(l => (
        ...
        <div className="border-t border-slate-200 mt-1 pt-1 text-xs text-slate-400">
      ...
      {selected && st && (
        <div className="absolute top-4 right-4 z-[1000] w-72 bg-white rounded-xl shadow-2xl border border-slate-200 flex flex-col max-h-[calc(100vh-80px)] overflow-y-auto">
          {/* Kart başlık */}
